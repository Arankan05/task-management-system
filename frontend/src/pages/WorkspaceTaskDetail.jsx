    ...
    return (
      <Layout>
        <div className="page-container">
          ...
          <Link to={base} className="btn-secondary mt-4 inline-flex"><ArrowLeft size={16} /> Back</Link>
        </div>
      </Layout>
    )
  }
  ...
  return (
    <Layout>
      <div className="page-container max-w-3xl">
        <Link to={base} className="inline-flex items-center gap-1 text-sm text-primary hover:underline mb-6">
