...
function Layout({ children }) {
  ...
  return (
    <div className="flex flex-col min-h-screen relative bg-surface-muted">
      ...
      <div className="flex flex-1 w-full max-w-[1600px] mx-auto p-4 md:p-6 lg:p-8 gap-6 relative z-10 items-start">
        <Sidebar mobileOpen={mobileOpen} onClose={() => setMobileOpen(false)} />
        <div className="flex flex-col flex-1 min-w-0 w-full">
          <main className="p-6 md:p-8 overflow-x-hidden spatial-main-container">
            {children}
          </main>
          <Footer />
        </div>
